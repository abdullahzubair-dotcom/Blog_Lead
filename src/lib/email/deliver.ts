...
import { sendEmail, sendEmailAs, type SendResult, type MailAttachment } from "./smtp";
...
export async function deliverOutreach(opts: {
  ...
  // Env-SMTP fallback (legacy/unstamped) has no attachment support — attachments require a per-user sender.
